...
jpeg(filename = "output/nitro.jpeg",
     width = 10, height = 6, units = "in", res= 400)

par(mfrow=c(1,2))
##plant group
par(mar=c(5,5,1,0))
plot(0:1,0:1,type="n",xlim=c(0.5,3.5), ylim=c(0,5), xaxt='n', ylab=narealab,
     xlab="")
...
jpeg(filename = "output/nitro2.jpeg",
     width = 8, height = 6, units = "in", res= 400)
par(mar=c(5,5,1,1))
boxplot(n_perc ~ uniqueid, data=nitro, outline = FALSE, ylab=narealab,
